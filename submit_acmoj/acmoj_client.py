...
def main():
    ...
    # Submit file/code sub-command
    submit_file_parser = subparsers.add_parser("submit-file", help="Submit code from local file")
    ...
    submit_file_parser.add_argument("--language", type=str, default="cpp", help="Language key (e.g., cpp)")
